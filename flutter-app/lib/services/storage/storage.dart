...
abstract interface class Storage {
  ...
  Future<Map<String, dynamic>?> get(
       String key,{String? value, String? by});
  ...
  /// * [by] - id value to compare with [value].
  Future<void> remove(
      {required String key, String? value, String? by});
  ...
  /// * [value] - unique value by which we will search for the element.
  /// * [by] - id value to compare with [value].
  Future<List<Map<String, dynamic>>> getAllWhere({required String key, required String value, required String by});
